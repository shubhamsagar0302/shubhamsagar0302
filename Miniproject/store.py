...
def welcome(): 
     ...
     textarea.insert(END,"\t Welcome SS Mobiles")
...
#===================Top section====================
title=Label(root,text='SS Billing Software' , bg=bg_color, fg='white',font=('times new rommon',25,'bold'),relief=GROOVE,bd=12)
title.pack(fill=X)
#==================customer details================
